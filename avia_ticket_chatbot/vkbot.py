...
# ответ преподавателя: -- это изменяемый элемент, в первый раз он будет создан пустым, вы что-нибудь в него добавите
# ответ преподавателя: в следующий объект будет создавать не новый, пустой элемент, а будет использовать тот же,
# ответ преподавателя: что был создан раньше. В итоге все данные попадут в один и тот же словарь, новые создаваться не будут
