...
# TODO Проверка правильных вариантов разных видов - это хорошо, но это только один из вариантов работы программы
# TODO Старайтесь исходить из 3 основных типов ввода:
# TODO ничего (пустая строка)
# TODO много всего(очень длинная строка правильных/неправильных символов)
# TODO ввод нужного размера (правильный/неправильный)
